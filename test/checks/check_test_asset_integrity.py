...
CANONICAL_REQUIRED = (
    ...
    Path("test/evaluation/parse_final_2026_results.py"),
    Path("test/evaluation/run_final_2026_evaluation.py"),
    Path("test/images/manifest.final-2026.json"),
...
CANONICAL_UNIT_PATHS = {
    ...
    Path("test/unit/test_final_2026_adapter.py"),
    Path("test/unit/test_final_2026_result_validation.py"),
