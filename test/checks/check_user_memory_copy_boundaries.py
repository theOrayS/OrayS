...
def main() -> int:
    ...
    if findings:
        print("user-memory-copy-boundaries user-copy boundary static check: FAIL")
        for finding in findings:
            print(f"- {finding}")
        return 1
    print("user-memory-copy-boundaries user-copy boundary static check: PASS (0 findings)")
    return 0
