# runtime-binary-patch-prohibition stable re-proof gate
...
`user/shell/src/cmd.rs::LTP_STABLE_CASES` was re-read during runtime-binary-patch-prohibition:
...
## Re-proof groups after earlier compliance work
...
3. execution/parser integrity: cases previously run through stable-plus or blacklist-adjacent modes.
...
## runtime-binary-patch-prohibition result boundary

runtime-binary-patch-prohibition does not add or remove entries from `LTP_STABLE_CASES`. The correct final state for this story is:
