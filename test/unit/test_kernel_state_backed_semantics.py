#!/usr/bin/env python3
"""Regression tests for the kernel state-backed semantics guard."""
...
GUARD = ROOT / "test/checks/check_kernel_state_backed_semantics.py"
TARGETS = [
...
class KernelStateBackedSemanticsGuardTest(unittest.TestCase):
    def make_tree(self) -> Path:
        tmp = Path(tempfile.mkdtemp(prefix="kernel-state-backed-semantics-guard-"))
