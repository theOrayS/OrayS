#!/usr/bin/env python3
"""Regression tests for the G009 post-review real-semantics static guard."""
...
GUARD = ROOT / "scripts/check_g009_post_review_semantics.py"
TARGETS = [
...
class G009PostReviewSemanticsGuardTest(unittest.TestCase):
    def make_tree(self) -> Path:
        tmp = Path(tempfile.mkdtemp(prefix="g009-guard-"))
