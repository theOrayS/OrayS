...
def scan_docs(root: Path) -> list[str]:
    manifest = root / "scripts/fixtures/g008-musl-patch-stable/musl-runtime-patch-manifest.md"
    gate = root / "scripts/fixtures/g008-musl-patch-stable/stable-reproof-gate.md"
    findings: list[str] = []
