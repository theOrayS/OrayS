#!/usr/bin/env python3
"""Static guard for G011 empty-success / half-stub libc surfaces."""
...
def main() -> int:
    ...
    if findings:
        print("FAIL: G011 empty-shell guard found issues:")
        for finding in findings:
            print(f"- {finding}")
        return 1
    print("PASS: G011 empty-shell guard found no success-without-state shells in scoped libc surfaces")
    return 0
