...
class G008MuslPatchStableGuardTest(unittest.TestCase):
    ...
    def test_detects_missing_retirement_doc_contract(self) -> None:
        tree = self.make_tree()
        path = tree / "scripts/fixtures/g008-musl-patch-stable/musl-runtime-patch-manifest.md"
    ...
    def test_detects_missing_four_combo_gate_doc(self) -> None:
        tree = self.make_tree()
        path = tree / "scripts/fixtures/g008-musl-patch-stable/stable-reproof-gate.md"
