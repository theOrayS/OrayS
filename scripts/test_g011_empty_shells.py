#!/usr/bin/env python3
"""Regression tests for the G011 empty-shell static guard."""
...
GUARD = ROOT / "scripts/check_g011_empty_shells.py"
TARGETS = [
...
class G011EmptyShellGuardTest(unittest.TestCase):
    def make_tree(self) -> Path:
        tmp = Path(tempfile.mkdtemp(prefix="g011-guard-"))
