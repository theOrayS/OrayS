#!/usr/bin/env python3
"""Regression tests for the G006 synthetic capability guard."""
...
class G006SyntheticCapabilityGuardTest(unittest.TestCase):
    def make_tree(self) -> Path:
        tmp = Path(tempfile.mkdtemp(prefix="g006-guard-"))
