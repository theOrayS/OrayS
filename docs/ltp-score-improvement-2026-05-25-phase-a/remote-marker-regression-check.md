...
No marker-prefix regression was observed in the fresh follow-up targeted gates, but final RV/LA stable350 marker-prefix checks were not run because stable350 was not reached. Aborted/untrusted `post-team-candidate*` and `followup-la-targeted-001/002/003` outputs remain excluded from promotion evidence regardless of marker shape.
