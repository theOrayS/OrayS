...
- 今天首个新计划与提示词使用 `docs/ltp-score-improvement-2026-05-22-phase-a/`；同一天后续文档继续使用 `phase-b`, `phase-c`。
...
- 新建今天的 context/brief，保存到 `docs/ltp-score-improvement-2026-05-22-phase-a/` 或 `.omx/context/`；历史证据继续引用 `2026-05-21-phase-*`。
