...
This checkpoint improves UTS semantics and adds 1 new unique candidate (`utsname02`), bringing the stable806 candidate pool to 3 unique cases. Baseline remains `756 total / 756 unique / 0 duplicate`; no milestone promotion commit is created until the next +50 unique clean cohort is available.
