...
Result after final stable656 promotion: `656 656 0`.
...
## open clean2 validation

RV scout command:

```bash
OSCOMP_TEST_GROUPS=ltp LTP_CASES=chmod04,chdir02,getcwd05,open05,open07,open11,open12,open14,open15,open16,close08,read03,write04,write07,write08,readv03 LTP_CASE_TIMEOUT_SECS=60 timeout 35m ./run-eval.sh rv
python3 scripts/ltp_summary.py target/ltp-1000-milestone-03-stable656/rv-fd-vfs-io-scout-20260602T153655+0800.log
python3 scripts/ltp_summary.py --json target/ltp-1000-milestone-03-stable656/rv-fd-vfs-io-scout-20260602T153655+0800.log
python3 scripts/ltp_summary.py --promotion-candidates --promotion-arches rv target/ltp-1000-milestone-03-stable656/rv-fd-vfs-io-scout-20260602T153655+0800.log
```

LA confirmation command:

```bash
OSCOMP_TEST_GROUPS=ltp LTP_CASES=open07,open12 LTP_CASE_TIMEOUT_SECS=60 timeout 15m ./run-eval.sh la
python3 scripts/ltp_summary.py target/ltp-1000-milestone-03-stable656/la-open-clean2-20260602T153756+0800.log
python3 scripts/ltp_summary.py --json target/ltp-1000-milestone-03-stable656/la-open-clean2-20260602T153756+0800.log
python3 scripts/ltp_summary.py --promotion-candidates --promotion-arches la target/ltp-1000-milestone-03-stable656/la-open-clean2-20260602T153756+0800.log
python3 scripts/ltp_summary.py --promotion-candidates --promotion-arches rv,la target/ltp-1000-milestone-03-stable656/rv-fd-vfs-io-scout-20260602T153655+0800.log target/ltp-1000-milestone-03-stable656/la-open-clean2-20260602T153756+0800.log
```

Artifacts:

- RV raw/summary/JSON/checksum: `target/ltp-1000-milestone-03-stable656/rv-fd-vfs-io-scout-20260602T153655+0800.log`, `target/ltp-1000-milestone-03-stable656/rv-fd-vfs-io-scout-20260602T153655+0800.summary.txt`, `target/ltp-1000-milestone-03-stable656/rv-fd-vfs-io-scout-20260602T153655+0800.summary.json`, `target/ltp-1000-milestone-03-stable656/rv-fd-vfs-io-scout-20260602T153655+0800.derived.sha256`.
- RV candidate report: `target/ltp-1000-milestone-03-stable656/rv-fd-vfs-io-scout-20260602T153655+0800.promotion-candidates.txt`.
- LA raw/summary/JSON/checksum: `target/ltp-1000-milestone-03-stable656/la-open-clean2-20260602T153756+0800.log`, `target/ltp-1000-milestone-03-stable656/la-open-clean2-20260602T153756+0800.summary.txt`, `target/ltp-1000-milestone-03-stable656/la-open-clean2-20260602T153756+0800.summary.json`, `target/ltp-1000-milestone-03-stable656/la-open-clean2-20260602T153756+0800.derived.sha256`.
- LA candidate report: `target/ltp-1000-milestone-03-stable656/la-open-clean2-20260602T153756+0800.promotion-candidates.txt`.
- Combined candidate report/checksum: `target/ltp-1000-milestone-03-stable656/combined-open-clean2-20260602T153844+0800.promotion-candidates.txt`, `target/ltp-1000-milestone-03-stable656/combined-open-clean2-20260602T153844+0800.derived.sha256`.

Parser summaries:

```text
RV scout: PASS LTP CASE 4, FAIL LTP CASE 28, Internal TFAIL/TBROK/TCONF 10 (TBROK=6, TCONF=4), timeout 0, ENOSYS 2, panic/trap 0.
RV clean candidates from that scout: open07, open12.
LA confirmation for clean candidates: PASS LTP CASE 4, FAIL LTP CASE 0, Internal TFAIL/TBROK/TCONF 0, timeout 0, ENOSYS 0, panic/trap 0.
Combined RV+LA: promotion candidates open07, open12; blocked/incomplete rows 14.
```

Unverified/deferred: no LA was run for the RV-blocked rows because their RV parser output already has visible blocker/fail evidence and they are not promotion candidates.

## pause clean2 validation

RV scout command:

```bash
OSCOMP_TEST_GROUPS=ltp LTP_CASES=alarm01,pause01,pause02,kill01,kill04,kill05,sigaction03,sigaction04,sigaction05,sigpending02,sigprocmask02,sigsuspend02,sigwait01,waitpid02,waitpid05,waitpid14,waitpid15,waitpid16,waitpid17,waitpid18,waitpid19 LTP_CASE_TIMEOUT_SECS=60 timeout 45m ./run-eval.sh rv
python3 scripts/ltp_summary.py target/ltp-1000-milestone-03-stable656/rv-signal-wait-scout-20260602T154048+0800.log
python3 scripts/ltp_summary.py --json target/ltp-1000-milestone-03-stable656/rv-signal-wait-scout-20260602T154048+0800.log
python3 scripts/ltp_summary.py --promotion-candidates --promotion-arches rv target/ltp-1000-milestone-03-stable656/rv-signal-wait-scout-20260602T154048+0800.log
```

LA confirmation command:

```bash
OSCOMP_TEST_GROUPS=ltp LTP_CASES=pause01,pause02 LTP_CASE_TIMEOUT_SECS=60 timeout 15m ./run-eval.sh la
python3 scripts/ltp_summary.py target/ltp-1000-milestone-03-stable656/la-pause-clean2-20260602T154154+0800.log
python3 scripts/ltp_summary.py --json target/ltp-1000-milestone-03-stable656/la-pause-clean2-20260602T154154+0800.log
python3 scripts/ltp_summary.py --promotion-candidates --promotion-arches la target/ltp-1000-milestone-03-stable656/la-pause-clean2-20260602T154154+0800.log
python3 scripts/ltp_summary.py --promotion-candidates --promotion-arches rv,la target/ltp-1000-milestone-03-stable656/rv-signal-wait-scout-20260602T154048+0800.log target/ltp-1000-milestone-03-stable656/la-pause-clean2-20260602T154154+0800.log
```

Artifacts:

- RV raw/summary/JSON/checksum: `target/ltp-1000-milestone-03-stable656/rv-signal-wait-scout-20260602T154048+0800.log`, `target/ltp-1000-milestone-03-stable656/rv-signal-wait-scout-20260602T154048+0800.summary.txt`, `target/ltp-1000-milestone-03-stable656/rv-signal-wait-scout-20260602T154048+0800.summary.json`, `target/ltp-1000-milestone-03-stable656/rv-signal-wait-scout-20260602T154048+0800.derived.sha256`.
- RV candidate report: `target/ltp-1000-milestone-03-stable656/rv-signal-wait-scout-20260602T154048+0800.promotion-candidates.txt`.
- LA raw/summary/JSON/checksum: `target/ltp-1000-milestone-03-stable656/la-pause-clean2-20260602T154154+0800.log`, `target/ltp-1000-milestone-03-stable656/la-pause-clean2-20260602T154154+0800.summary.txt`, `target/ltp-1000-milestone-03-stable656/la-pause-clean2-20260602T154154+0800.summary.json`, `target/ltp-1000-milestone-03-stable656/la-pause-clean2-20260602T154154+0800.derived.sha256`.
- LA candidate report: `target/ltp-1000-milestone-03-stable656/la-pause-clean2-20260602T154154+0800.promotion-candidates.txt`.
- Combined candidate report/checksum: `target/ltp-1000-milestone-03-stable656/combined-pause-clean2-20260602T154237+0800.promotion-candidates.txt`, `target/ltp-1000-milestone-03-stable656/combined-pause-clean2-20260602T154237+0800.derived.sha256`.

Parser summaries:

```text
RV scout: PASS LTP CASE 4, FAIL LTP CASE 38, Internal TFAIL/TBROK/TCONF 10 (TFAIL=8, TBROK=2), timeout 0, ENOSYS 0, panic/trap 0.
RV clean candidates from that scout: pause01, pause02.
LA confirmation for clean candidates: PASS LTP CASE 4, FAIL LTP CASE 0, Internal TFAIL/TBROK/TCONF 0, timeout 0, ENOSYS 0, panic/trap 0.
Combined RV+LA: promotion candidates pause01, pause02; blocked/incomplete rows 19.
```
...
## Final stable656 checksum manifest

Checksum manifest: `target/ltp-1000-milestone-03-stable656/stable656-final-gate-20260602T163900+0800.sha256`

```text
05d5c6286b64f417c04abffbd971f05c5d6c8e9e8bba1560ed27b2eaaf1c4073  target/ltp-1000-milestone-03-stable656/rv-stable656-new50-post-timer-safe-20260602T163655+0800.log
c249d4f2ee4d69be1bddddbab5a153406b6874ef066ed9e673a81ba2b4b6e9f6  target/ltp-1000-milestone-03-stable656/rv-stable656-new50-post-timer-safe-20260602T163655+0800.summary.txt
83379492e31c2065ed5c9dc50d8cb8bb67234ecbe164a10408990ee773ddec5a  target/ltp-1000-milestone-03-stable656/rv-stable656-new50-post-timer-safe-20260602T163655+0800.promotion-rv.md
9d48e37fcba661f4add9d356ab8ca3d46cfe81481a38f79aa60b7afbcd46761d  target/ltp-1000-milestone-03-stable656/la-stable656-new50-final-timer-safe2-20260602T163306+0800.log
f809abf7ce706638020d3454126f0fb388575c4a4c28ea3d66630dfab987b70b  target/ltp-1000-milestone-03-stable656/la-stable656-new50-final-timer-safe2-20260602T163306+0800.summary.txt
71354e594c1acae985945f541c4f915f80c32babf5cbf22be4c9e2222bba4dd2  target/ltp-1000-milestone-03-stable656/la-stable656-new50-final-timer-safe2-20260602T163306+0800.promotion-la.md
3ff8218471c0282c3d4ea9c89492ac1909c55f953d9ca4f6be6b01a199c7e12c  target/ltp-1000-milestone-03-stable656/la-futex-wait01-timer-safe-deadline-20260602T163142+0800.summary.txt
```
