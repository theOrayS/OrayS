...
- 首轮独立只读 AI reviewer 已完成，但其 1 个 unsafe-contract Major 在 fresh
  smoke/full 与 follow-up review 前尚未清零；人类负责人也尚未确认可独立解释和调试。

## 后续工作

先提交首轮 reviewer 的 unsafe 契约与 active-plan 窄修复，执行 fresh RV64/LA64
repository-contained smoke 和 full/all，再由独立 reviewer follow-up 确认 Major/Minor
处置。其后仍须修正外部 BusyBox plan并通过受控 provenance 重新生成两架构 image，
...
1 Major、1 Minor，unsafe 契约/计划修复及其 fresh evidence 尚在进行。因此 `main`
