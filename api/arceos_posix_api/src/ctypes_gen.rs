...
pub struct aibuf {
    pub ai: addrinfo,
    pub sa: aibuf_sa,
    pub canonname: [::core::ffi::c_char; 256usize],
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of aibuf"][::core::mem::size_of::<aibuf>() - 344usize];
    ...
    ["Offset of field: aibuf::canonname"][::core::mem::offset_of!(aibuf, canonname) - 76usize];
    ["Offset of field: aibuf::lock"][::core::mem::offset_of!(aibuf, lock) - 332usize];
    ["Offset of field: aibuf::slot"][::core::mem::offset_of!(aibuf, slot) - 336usize];
    ["Offset of field: aibuf::ref_"][::core::mem::offset_of!(aibuf, ref_) - 338usize];
};
...
pub struct pthread_mutex_t {
    pub __l: [::core::ffi::c_ulonglong; 5usize],
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
