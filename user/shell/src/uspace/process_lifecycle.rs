...
fn load_program_with_env(
    ...
    let process = Arc::new(UserProcess {
        ...
        path_modes: Arc::new(Mutex::new(initial_path_modes())),
        path_inodes: Arc::new(Mutex::new(BTreeMap::new())),
        path_special_modes: Arc::new(Mutex::new(BTreeMap::new())),
        path_rdevs: Arc::new(Mutex::new(BTreeMap::new())),
        path_owners: Arc::new(Mutex::new(BTreeMap::new())),
        path_symlinks: Arc::new(Mutex::new(BTreeMap::new())),
        path_hardlinks: Arc::new(Mutex::new(BTreeMap::new())),
        path_hardlink_counts: Arc::new(Mutex::new(BTreeMap::new())),
        path_inode_flags: Arc::new(Mutex::new(BTreeMap::new())),
        path_xattrs: Arc::new(Mutex::new(BTreeMap::new())),
        path_times: Arc::new(Mutex::new(BTreeMap::new())),
...
impl UserProcess {
    ...
    pub(super) fn fork_with_fd_sharing(
        ...
        let child = Arc::new(UserProcess {
            ...
            path_modes: self.path_modes.clone(),
            path_inodes: self.path_inodes.clone(),
            path_special_modes: self.path_special_modes.clone(),
            path_rdevs: self.path_rdevs.clone(),
            path_owners: self.path_owners.clone(),
            path_symlinks: self.path_symlinks.clone(),
            path_hardlinks: self.path_hardlinks.clone(),
            path_hardlink_counts: self.path_hardlink_counts.clone(),
            path_inode_flags: self.path_inode_flags.clone(),
            path_xattrs: self.path_xattrs.clone(),
